...
PRESETS: dict[str, dict[str, Any]] = {
    "Balanced (default)": {
        "modes": ["attack", "defend", "abandon"],
        "w_attack": 1.45,
        "w_defend": 1.25,
        "cost_sensitivity": 1.15,
        "risk_tolerance": 0.52,
        "abandon_enabled": True,
        "description": "Attack weak Ds, defend strong R holds, flag money pits.",
    },
    "Attack weak Democrats": {
        "modes": ["attack", "abandon"],
        "w_attack": 1.8,
        "w_defend": 0.4,
        "cost_sensitivity": 1.1,
        "risk_tolerance": 0.52,
        "abandon_enabled": True,
        "description": "Maximize flips of fragile/near-even D seats.",
    },
    "Defend strong Republicans": {
        ...
        "risk_tolerance": 0.55,
        "abandon_enabled": True,
        "description": "Lock in R-favored holds and rescues; skip pure flips.",
    },
    "Hide abandon": {
        "modes": ["attack", "defend"],
        "w_attack": 1.45,
        ...
        "description": "Attack/defend only; no abandon flagging.",
    },
    "Top ROI (strict cost)": {
        "modes": ["attack", "defend", "abandon"],
        "w_attack": 1.5,
        ...
        "risk_tolerance": 0.52,
        "abandon_enabled": True,
        "description": "Harsh cost penalty — abandon expensive traps faster.",
    },
}
